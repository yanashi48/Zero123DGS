...
python eval_colmap2.py --dir output/poro/images --project output/poro --name poro --colmap /usr/local/bin/colmap

python amg2.py --checkpoint models/sam_vit_h_4b8939.pth --model-type default --input output/poro/images --output output/poro/masks
